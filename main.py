...
from agents.actors.optimization_actor import OptimizationActor
...
def test(env_config: EnvConfig, actor: object, learner: object):
    ...
    # Plot true and estimated preferences
    # plt.figure(figsize=(12, 6))
    # plt.plot(true_preferences, label="True Preferences")
    # plt.plot(estimated_preferences, label="Estimated Preferences")
    # plt.fill_between(
    #     range(len(estimated_preferences)),
    #     [
    #         estimated_preferences[i] - estimated_preferences_variances[i]
    #         for i in range(len(estimated_preferences))
    #     ],
    #     [
    #         estimated_preferences[i] + estimated_preferences_variances[i]
    #         for i in range(len(estimated_preferences))
    ...
    # plt.title("True vs Estimated Preferences")
    # plt.legend()
    # plt.show()
...
if __name__ == "__main__":
    ...
    for beta in BETAS:
        ...
        for i in range(NUM_SIMULATIONS):
            ...
            # Create the agent
            actor = OptimizationActor(env_config=env_config, beta=beta)
